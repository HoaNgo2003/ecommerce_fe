    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1">
        ...
        <div className="p-6">
          ...
          <h1 className="text-2xl font-bold mb-8">Add Attribute</h1>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="aspect-square border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-gray-400 cursor-pointer hover:border-blue-500 hover:text-blue-500">
